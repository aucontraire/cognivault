...
class TestCogniVaultMemoryManager:
    ...
    @pytest.fixture
    def memory_manager(self, enabled_config: Any) -> Any:
    ...
    @pytest.fixture
    def disabled_memory_manager(self, disabled_config: Any) -> Any:
    ...
    def test_initialization_disabled(self, disabled_memory_manager: Any) -> None:
    ...
    def test_initialization_enabled(self, memory_manager: Any) -> None:
    ...
    def test_generate_thread_id(self, memory_manager: Any) -> None:
    ...
    def test_get_thread_id_provided(self, memory_manager: Any) -> None:
    ...
    def test_get_thread_id_from_config(self, memory_manager: Any) -> None:
    ...
    def test_get_thread_id_auto_generate(self) -> None:
    ...
    def test_get_thread_id_fallback(self) -> None:
    ...
    def test_create_checkpoint_disabled(
        self, disabled_memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_create_checkpoint_enabled(
        self, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_checkpoint_limit_enforcement(
        self, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_get_checkpoint_history(
        self, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_get_checkpoint_history_empty(self, memory_manager: Any) -> None:
    ...
    def test_get_latest_checkpoint_none(self, memory_manager: Any) -> None:
    ...
    def test_cleanup_no_ttl(self, sample_state: Any) -> None:
    ...
    def test_cleanup_removes_empty_threads(
        self, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_rollback_disabled_checkpointing(
        self, disabled_memory_manager: Any
    ) -> None:
        """Test rollback when checkpointing is disabled."""
        result = disabled_memory_manager.rollback_to_checkpoint("test_thread")
        assert result is None

    def test_rollback_disabled_rollback_flag(self, sample_state: Any) -> None:
    ...
    def test_rollback_no_checkpoints(self, memory_manager: Any) -> None:
        """Test rollback when no checkpoints exist."""
        result = memory_manager.rollback_to_checkpoint("nonexistent_thread")
        assert result is None

    def test_rollback_specific_checkpoint_not_found(
        self, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_rollback_fallback_success(
        self, mock_create_state: Mock, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_rollback_with_memory_saver_data(
        self, memory_manager: Any, sample_state: Any
    ) -> None:
    ...
    def test_state_serialization(self, memory_manager: Any, sample_state: Any) -> None:
    ...
    def test_state_serialization_error_fallback(self, memory_manager: Any) -> None:
    ...
    def test_deserialization_error_handling(self, memory_manager: Any) -> None:
    ...
    def test_complex_type_serialization(self, memory_manager: Any) -> None:
    ...
    def test_get_memory_stats(self, memory_manager: Any, sample_state: Any) -> None:
...
class TestFactoryFunction:
    ...
    def test_factory_enabled(self, mock_memory_saver: Mock) -> None:
...
class TestErrorHandling:
    ...
    @pytest.fixture
    def manager_with_mock_memory_saver(self) -> Any:
    ...
    def test_rollback_exception_handling(
        self, manager_with_mock_memory_saver: Any, sample_state: Any
    ) -> None:
    ...
    def test_serialization_with_circular_reference(self, memory_manager: Any) -> None:
        """Test serialization with circular references."""
        # Create circular reference
        state_dict = {"query": "test", "execution_id": "test_123"}
        state_dict["circular"] = state_dict  # type: ignore[assignment]
