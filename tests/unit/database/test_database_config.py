...
class TestDatabaseConfig:
    ...
    def test_validate_invalid_pool_settings(self):
    ...
    def test_mask_credentials_no_password(self):
    ...
    def test_ssl_context_with_files(self, mock_exists):
    ...
    @patch("os.path.exists")
    def test_ssl_context_missing_files(self, mock_exists):
    ...
    @patch("os.path.exists")
    def test_validate_missing_ssl_files(self, mock_exists):
...
class TestGlobalDatabaseConfig:
    ...
    def test_get_database_config_creates_singleton(self):
