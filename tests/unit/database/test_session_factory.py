...
class TestDatabaseSessionFactory:
    ...
    @pytest.fixture
    def mock_session_factory_func(self, mock_session: Mock) -> Any:
        """Create a mock session factory function."""
        factory_func: MagicMock = MagicMock()
        factory_func.return_value = mock_session
        return factory_func

    def test_session_factory_initial_state(self, session_factory: Mock) -> None:
    ...
    async def test_initialize_success(
        self,
        mock_get_session_factory: Mock,
        mock_get_engine: Mock,
        session_factory: Mock,
        mock_session_factory_func: Mock,
        mock_session: Mock,
    ) -> None:
    ...
    async def test_initialize_failure(
        self, mock_get_engine: Mock, session_factory: Mock
    ) -> None:
    ...
    async def test_initialize_already_initialized(self, session_factory: Mock) -> None:
    ...
    async def test_shutdown(self, mock_close_db: Mock, session_factory: Mock) -> None:
    ...
    async def test_shutdown_not_initialized(self, session_factory: Mock) -> None:
        """Test shutdown when not initialized."""
        # Should not raise error
        await session_factory.shutdown()
        assert not session_factory.is_initialized

    async def test_get_session_not_initialized(self, session_factory: Mock) -> None:
    ...
    async def test_get_session_success(
        self, session_factory: Mock, mock_session_factory_func: Mock, mock_session: Mock
    ) -> None:
    ...
    async def test_get_repository_factory(
        ...
        mock_repo_factory: MagicMock = MagicMock()
    ...
    async def test_execute_with_session(
        ...
        async def test_operation(session: Mock, arg1: str, arg2: str) -> str:
            assert session is mock_session
    ...
    async def test_execute_with_repositories(
        ...
        async def test_operation(repo_factory: Mock, arg1: str) -> str:
            assert repo_factory is mock_repo_factory
            assert arg1 == "test_arg"
    ...
    async def test_health_check_not_initialized(self, session_factory: Mock) -> None:
...
class TestGlobalSessionFactory:
    ...
    def test_get_database_session_factory_singleton(self) -> None:
    ...
    async def test_initialize_database_session_factory(
        self, mock_get_factory: Mock
    ) -> None:
    ...
    @patch("cognivault.database.session_factory.get_database_session_factory")
    async def test_shutdown_database_session_factory(
        self, mock_get_factory: Mock
    ) -> None:
    ...
    async def test_shutdown_database_session_factory_none(self) -> None:
...
class TestSessionFactoryIntegration:
    ...
    @pytest.fixture
    async def initialized_session_factory(self) -> Any:
    ...
    async def test_repository_operations_integration(
        self, mock_repo_factory_class: Mock, initialized_session_factory: Mock
    ) -> None:
        ...
        async def create_topic_operation(repo_factory: Mock, name: str) -> Any:
    ...
    async def test_multiple_concurrent_sessions(
        self, initialized_session_factory: Mock
    ) -> None:
        """Test that multiple concurrent sessions work correctly."""
        factory, mock_session = initialized_session_factory

        async def concurrent_operation(session_num: int) -> str:
