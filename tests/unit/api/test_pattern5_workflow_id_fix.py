...
class TestPattern5WorkflowIdFix:
    ...
    async def test_single_workflow_id_passed_to_orchestrator(
        ...
        with (
            patch(
                "cognivault.api.orchestration_api.emit_workflow_started"
            ) as mock_emit_started,
            patch(
                "cognivault.api.orchestration_api.emit_workflow_completed"
    ...
    async def test_orchestrator_config_includes_workflow_id(self) -> None:
        ...
        with (
            patch("cognivault.api.orchestration_api.emit_workflow_started"),
