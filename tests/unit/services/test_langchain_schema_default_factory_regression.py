...
class TestEdgeCases:
    ...
    def test_field_with_both_default_factory_and_optional(self) -> None:
        ...
        assert (
            "anyOf" in optional_timestamp_def
    ...
    def test_required_field_no_default(self) -> None:
        ...
        assert (
            "anyOf" not in required_name_def
