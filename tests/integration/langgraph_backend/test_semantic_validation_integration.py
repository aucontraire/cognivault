...
class TestGraphFactoryValidationIntegration:
    ...
    @pytest.fixture
    def factory_with_validation(self, validator: Mock) -> Any:
        """Fixture for GraphFactory with default validator."""
        return GraphFactory(default_validator=validator)

    @pytest.fixture
    def factory_without_validation(self) -> Any:
        """Fixture for GraphFactory without validation."""
        return GraphFactory()

    def test_factory_initialization_with_validator(self, validator: Mock) -> None:
    ...
    def test_factory_initialization_without_validator(self) -> None:
    ...
    def test_create_graph_with_validation_enabled_valid(
        self, mock_state_graph: Mock, factory_with_validation: Mock
    ) -> None:
    ...
    def test_validate_workflow_no_validator(
        self, factory_without_validation: Mock
    ) -> None:
    ...
    def test_set_default_validator(
        self, factory_without_validation: Mock, validator: Mock
    ) -> None:
    ...
    def test_config_validator_overrides_default(
        self, factory_with_validation: Mock, strict_validator: Mock
    ) -> None:
    ...
    def test_validation_with_unknown_agents(
        self, factory_with_validation: Mock
    ) -> None:
    ...
    def test_validation_error_details(self, factory_with_validation: Mock) -> None:
...
class TestRealWorldValidationScenarios:
    ...
    def test_typical_workflow_validations(self) -> None:
    ...
    def test_problematic_workflow_validations(self) -> None:
